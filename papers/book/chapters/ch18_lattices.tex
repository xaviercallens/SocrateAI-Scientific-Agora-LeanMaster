...
\begin{leancode}
-- exercise: not yet proved (not in the library)
def cartanA2 : Gram 2 := !![2, -1; -1, 2]
theorem cartanA2_det : cartanA2.det = 3 := by
  simp [cartanA2, Matrix.det_fin_two]; norm_num
\end{leancode}
Repair the proof if necessary, and deduce that \texttt{IsUnimodular cartanA2} is false. Then prove that it has even diagonal, imitating
