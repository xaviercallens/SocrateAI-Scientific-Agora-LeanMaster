...
final gate}. \textbf{Not proved at the time.} That $G=1$ is the \emph{only} minimizer
(\cref{ex:open:dualscale-unique} of \cref{ch:open}); this was proved later, as
\lean{dualScale\_eq\_iff}. The physical
