...
deliberately modest. It identifies \lean{ModeData} with nothing physical; the identification
...
\lean{numNeumann bc := (Finset.univ.filter fun j => bc j = true).card}. State and prove: if
