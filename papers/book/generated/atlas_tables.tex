...
\texttt{\small bMinus} & {\scriptsize UseCases.K3SignatureTheorem} & def & 5 \\
...
\texttt{\small toNat} & {\scriptsize Epistemic.Tier} & def & 5 \\
...
\texttt{\scriptsize IsOrderedRing.toMulPosMono} & 6 & \texttt{\small energy\_dissipation}, \texttt{\small regularity\_lifting}, \texttt{\small sobolev\_embedding} \\
...
\bottomrule \endfoot
0.63 & 0.11 & \texttt{\small k3\_euler\_characteristic}\newline {\scriptsize K3Topology} & \texttt{\small k3\_euler\_eq\_24}\newline {\scriptsize Moonshine.KummerTadpole} \\
0.57 & 0.02 & \texttt{\small mukai\_rank\_and\_signature}\newline {\scriptsize Problems.Problem4\_MukaiMonodromy} & \texttt{\small mukai\_rank}\newline {\scriptsize StringDynamics.MukaiLattice} \\
...
0.53 & 0.45 & \texttt{\small euler\_K3}\newline {\scriptsize Flux.Tadpole} & \texttt{\small k3\_euler\_characteristic}\newline {\scriptsize Frontier.HodgeNumbers} \\
0.52 & 0.03 & \texttt{\small golay\_self\_dual\_dimension}\newline {\scriptsize Problems.Problem8\_GolayHolography} & \texttt{\small golay\_code\_rate\_is\_half}\newline {\scriptsize Quantum.TensorNetworkBridge} \\
0.51 & 0.02 & \texttt{\small rr\_tadpole\_cancellation}\newline {\scriptsize UseCase3\_FrontierTriad} & \texttt{\small tadpole\_cancellation}\newline {\scriptsize StringDynamics.TadpoleConstraint} \\
0.51 & 0.25 & \texttt{\small kummer\_exceptional\_intersection}\newline {\scriptsize Moonshine.KummerTadpole} & \texttt{\small exceptional\_self\_intersection}\newline {\scriptsize StringDynamics.KummerBlowup} \\
0.49 & 0.01 & \texttt{\small k3\_euler\_characteristic}\newline {\scriptsize K3Topology} & \texttt{\small k3\_euler\_characteristic}\newline {\scriptsize Frontier.HodgeNumbers} \\
0.47 & 0.09 & \texttt{\small mukai\_rank\_and\_signature}\newline {\scriptsize Problems.Problem4\_MukaiMonodromy} & \texttt{\small mukai\_signature\_difference}\newline {\scriptsize ModularForms.FermatModularBridge} \\
0.47 & 0.01 & \texttt{\small k3\_euler\_eq\_24}\newline {\scriptsize Moonshine.KummerTadpole} & \texttt{\small k3\_euler\_characteristic}\newline {\scriptsize Frontier.HodgeNumbers} \\
0.46 & 0.01 & \texttt{\small k3\_euler\_characteristic}\newline {\scriptsize K3Topology} & \texttt{\small k3\_euler\_characteristic\_identity}\newline {\scriptsize Problems.Problem9\_KummerModularity} \\
0.46 & 0.11 & \texttt{\small d7\_positive\_charge}\newline {\scriptsize Moonshine.KummerTadpole} & \texttt{\small total\_D7\_charge\_is\_64}\newline {\scriptsize StringTheory.TadpoleCancellation} \\
...
0.46 & 0.04 & \texttt{\small mukai\_rank\_and\_signature}\newline {\scriptsize Problems.Problem4\_MukaiMonodromy} & \texttt{\small mukai\_lattice\_rank\_equals\_24}\newline {\scriptsize ModularForms.FermatModularBridge} \\
0.46 & 0.00 & \texttt{\small golay\_holography\_master\_contract}\newline {\scriptsize Problems.Problem8\_GolayHolography} & \texttt{\small golay\_length\_matches\_k3\_euler}\newline {\scriptsize Quantum.TensorNetworkBridge} \\
0.44 & 0.67 & \texttt{\small k3t2\_euler\_zero}\newline {\scriptsize Flux.Tadpole} & \texttt{\small k3\_euler\_characteristic}\newline {\scriptsize Frontier.HodgeNumbers} \\
0.44 & 0.01 & \texttt{\small odd\_metric\_involutive}\newline {\scriptsize PhysLib.PhysLibKinematicsBridge} & \texttt{\small odd\_metric\_d1}\newline {\scriptsize StringDynamics.ODDMetric} \\
0.44 & 0.01 & \texttt{\small k3\_second\_betti\_hodge}\newline {\scriptsize K3Topology} & \texttt{\small k3\_euler\_characteristic}\newline {\scriptsize Frontier.HodgeNumbers} \\
0.43 & 0.35 & \texttt{\small buscher\_log\_involution}\newline {\scriptsize TDualityBuscher} & \texttt{\small buscher\_log\_involution}\newline {\scriptsize UseCase1\_ModuliStabilization} \\
0.43 & 0.02 & \texttt{\small golay\_holography\_master\_contract}\newline {\scriptsize Problems.Problem8\_GolayHolography} & \texttt{\small golay\_code\_rate\_is\_half}\newline {\scriptsize Quantum.TensorNetworkBridge} \\
0.43 & 0.03 & \texttt{\small m24\_order\_divisible\_by\_bps\_lock}\newline {\scriptsize UseCase2\_MoonshineBPS} & \texttt{\small conductor\_divisible\_by\_first\_five\_primes}\newline {\scriptsize Problems.Problem2\_MathieuFrobeniusRigidity} \\
0.43 & 0.08 & \texttt{\small rr\_tadpole\_cancellation}\newline {\scriptsize UseCase3\_FrontierTriad} & \texttt{\small rr\_tadpole\_cancellation}\newline {\scriptsize Moonshine.KummerTadpole} \\
0.43 & 0.02 & \texttt{\small k3\_euler\_characteristic\_identity}\newline {\scriptsize Problems.Problem9\_KummerModularity} & \texttt{\small k3\_euler\_eq\_24}\newline {\scriptsize Moonshine.KummerTadpole} \\
0.42 & 0.11 & \texttt{\small k3\_second\_betti\_hodge}\newline {\scriptsize K3Topology} & \texttt{\small k3\_euler\_eq\_24}\newline {\scriptsize Moonshine.KummerTadpole} \\
0.42 & 0.01 & \texttt{\small k3\_second\_betti\_hodge}\newline {\scriptsize K3Topology} & \texttt{\small k3\_euler\_characteristic\_identity}\newline {\scriptsize Problems.Problem9\_KummerModularity} \\
0.42 & 0.01 & \texttt{\small distance\_conjecture\_monotonicity}\newline {\scriptsize StringTheory.Swampland} & \texttt{\small sdc\_tower\_mass\_pos}\newline {\scriptsize StringDynamics.SwamplandSafe} \\
0.42 & 0.05 & \texttt{\small euler\_K3}\newline {\scriptsize Flux.Tadpole} & \texttt{\small k3\_b2}\newline {\scriptsize Frontier.HodgeNumbers} \\
0.42 & 0.02 & \texttt{\small rank\_K3T2}\newline {\scriptsize Lattice.K3T2Signature} & \texttt{\small total\_k3t2\_moduli\_dim\_eq\_80}\newline {\scriptsize FrontierTriad.SwamplandDistance} \\
0.42 & 0.02 & \texttt{\small rank\_K3}\newline {\scriptsize Lattice.K3T2Signature} & \texttt{\small mukai\_rank\_and\_signature}\newline {\scriptsize Problems.Problem4\_MukaiMonodromy} \\
0.41 & 0.07 & \texttt{\small k3\_euler\_characteristic}\newline {\scriptsize K3Topology} & \texttt{\small kummer\_exceptional\_intersection}\newline {\scriptsize Moonshine.KummerTadpole} \\
0.41 & 0.49 & \texttt{\small k3\_euler\_characteristic}\newline {\scriptsize K3Topology} & \texttt{\small k3t2\_euler\_char\_eq\_zero}\newline {\scriptsize Moonshine.KummerTadpole} \\
0.41 & 0.01 & \texttt{\small golay\_error\_radius\_equals\_three}\newline {\scriptsize Problems.Problem8\_GolayHolography} & \texttt{\small golay\_length\_matches\_k3\_euler}\newline {\scriptsize Quantum.TensorNetworkBridge} \\
0.40 & 0.33 & \texttt{\small atlas\_poincare\_curvature\_negative}\newline {\scriptsize Atlas.AtlasGeometryBridge} & \texttt{\small poincare\_geodesic\_atlas\_curvature}\newline {\scriptsize Frontier.ModuliGeodesics} \\
0.40 & 0.01 & \texttt{\small rr\_tadpole\_cancellation}\newline {\scriptsize Moonshine.KummerTadpole} & \texttt{\small tadpole\_cancellation}\newline {\scriptsize StringDynamics.TadpoleConstraint} \\
\end{longtable}
