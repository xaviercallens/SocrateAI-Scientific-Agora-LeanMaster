...
\quad\texttt{\footnotesize etaR\_mul\_self} & {\footnotesize } \\
\quad\texttt{\footnotesize genMetric\_symm} & {\footnotesize } \\
...
\quad\texttt{\footnotesize etaPair\_self} & {\footnotesize } \\
...
\quad\texttt{\footnotesize momentumFrame\_isSection} & {\footnotesize } \\
\quad\texttt{\footnotesize windingFrame\_isSection} & {\footnotesize } \\
\multicolumn{2}{l}{\textsf{\small DualScaleStream2.DualScale.TraceBound}} \\
\quad\texttt{\footnotesize circle\_effective\_scale\_ge\_two} & {\footnotesize Dual scale (G) = tr H(G, 0). -/ noncomputable def dualScale (G : Matrix (Fin d) (Fin d) ) :  := (genMetric G 0).trace theorem dualScale\_eq (G : Matrix} \\
\quad\texttt{\footnotesize dualScale\_circle} & {\footnotesize Dual scale (G) = tr H(G, 0). -/ noncomputable def dualScale (G : Matrix (Fin d) (Fin d) ) :  := (genMetric G 0).trace theorem dualScale\_eq (G : Matrix} \\
\quad\texttt{\footnotesize dualScale\_eq} & {\footnotesize } \\
\quad\texttt{\footnotesize dualScale\_ge} & {\footnotesize Dual scale (G) = tr H(G, 0). -/ noncomputable def dualScale (G : Matrix (Fin d) (Fin d) ) :  := (genMetric G 0).trace theorem dualScale\_eq (G : Matrix} \\
\quad\texttt{\footnotesize dualScale\_inv} & {\footnotesize Dual scale (G) = tr H(G, 0). -/ noncomputable def dualScale (G : Matrix (Fin d) (Fin d) ) :  := (genMetric G 0).trace theorem dualScale\_eq (G : Matrix} \\
\quad\texttt{\footnotesize dualScale\_one} & {\footnotesize Dual scale (G) = tr H(G, 0). -/ noncomputable def dualScale (G : Matrix (Fin d) (Fin d) ) :  := (genMetric G 0).trace theorem dualScale\_eq (G : Matrix} \\
...
\quad\texttt{\footnotesize kronForm\_evenDiag} & {\footnotesize } \\
\quad\texttt{\footnotesize kronForm\_symm} & {\footnotesize } \\
...
\quad\texttt{\footnotesize euler\_T2} & {\footnotesize } \\
...
\quad\texttt{\footnotesize even\_quadratic\_form\_of\_even\_diag} & {\footnotesize An integral lattice of rank n, presented by its Gram matrix in a chosen basis. -/ abbrev Gram (n : ) := Matrix (Fin n) (Fin n)  /-- Even diagonal. For} \\
\quad\texttt{\footnotesize isUnimodular\_of\_mul\_eq\_one} & {\footnotesize An integral lattice of rank n, presented by its Gram matrix in a chosen basis. -/ abbrev Gram (n : ) := Matrix (Fin n) (Fin n)  /-- Even diagonal. For} \\
\multicolumn{2}{l}{\textsf{\small DualScaleStream2.Lattice.E8}} \\
\quad\texttt{\footnotesize cartanE8Inv\_mul} & {\footnotesize } \\
\quad\texttt{\footnotesize cartanE8\_evenDiag} & {\footnotesize } \\
\quad\texttt{\footnotesize cartanE8\_symm} & {\footnotesize } \\
\quad\texttt{\footnotesize cartanE8\_unimodular} & {\footnotesize Cartan matrix of E8 (positive definite form). -/ def cartanE8 : Gram 8 := !![ 2, -1, 0, 0, 0, 0, 0, 0; -1, 2, -1, 0, 0, 0, 0, 0; 0, -1, 2, -1, 0, 0, 0} \\
\quad\texttt{\footnotesize e8Neg\_evenDiag} & {\footnotesize } \\
\quad\texttt{\footnotesize e8Neg\_symm} & {\footnotesize } \\
\quad\texttt{\footnotesize e8Neg\_unimodular} & {\footnotesize } \\
\multicolumn{2}{l}{\textsf{\small DualScaleStream2.Lattice.E8PosDef}} \\
\quad\texttt{\footnotesize cartanE8\_det} & {\footnotesize Unit lower-triangular factor. -/ noncomputable def e8L : Matrix (Fin 8) (Fin 8)  := !![1, 0, 0, 0, 0, 0, 0, 0; -1/2, 1, 0, 0, 0, 0, 0, 0; 0, -2/3, 1, } \\
\quad\texttt{\footnotesize cartanE8\_posDef} & {\footnotesize Unit lower-triangular factor. -/ noncomputable def e8L : Matrix (Fin 8) (Fin 8)  := !![1, 0, 0, 0, 0, 0, 0, 0; -1/2, 1, 0, 0, 0, 0, 0, 0; 0, -2/3, 1, } \\
\quad\texttt{\footnotesize e8\_LDL} & {\footnotesize Unit lower-triangular factor. -/ noncomputable def e8L : Matrix (Fin 8) (Fin 8)  := !![1, 0, 0, 0, 0, 0, 0, 0; -1/2, 1, 0, 0, 0, 0, 0, 0; 0, -2/3, 1, } \\
\multicolumn{2}{l}{\textsf{\small DualScaleStream2.Lattice.Hyperbolic}} \\
\quad\texttt{\footnotesize hyperbolicU\_congruence} & {\footnotesize Hyperbolic plane U. -/ def hyperbolicU : Gram 2 := !![0, 1; 1, 0] theorem hyperbolicU\_symm : hyperbolicU = hyperbolicU := by ext i j fin\_cases i <;> f} \\
\quad\texttt{\footnotesize hyperbolicU\_eq\_narain\_gram} & {\footnotesize Hyperbolic plane U. -/ def hyperbolicU : Gram 2 := !![0, 1; 1, 0] theorem hyperbolicU\_symm : hyperbolicU = hyperbolicU := by ext i j fin\_cases i <;> f} \\
\quad\texttt{\footnotesize hyperbolicU\_evenDiag} & {\footnotesize } \\
\quad\texttt{\footnotesize hyperbolicU\_mul\_self} & {\footnotesize Hyperbolic plane U. -/ def hyperbolicU : Gram 2 := !![0, 1; 1, 0] theorem hyperbolicU\_symm : hyperbolicU = hyperbolicU := by ext i j fin\_cases i <;> f} \\
\quad\texttt{\footnotesize hyperbolicU\_symm} & {\footnotesize } \\
\quad\texttt{\footnotesize hyperbolicU\_unimodular} & {\footnotesize } \\
\multicolumn{2}{l}{\textsf{\small DualScaleStream2.Lattice.K3T2Signature}} \\
\quad\texttt{\footnotesize index\_mod\_eight} & {\footnotesize Signature (b, b) of a non-degenerate real quadratic form. -/ structure Signature where pos :  neg :  deriving DecidableEq, Repr namespace Signature in} \\
\quad\texttt{\footnotesize rank\_K3} & {\footnotesize } \\
\quad\texttt{\footnotesize rank\_K3T2} & {\footnotesize } \\
\quad\texttt{\footnotesize sigK3T2\_eq} & {\footnotesize } \\
\quad\texttt{\footnotesize sigK3\_eq} & {\footnotesize } \\
\quad\texttt{\footnotesize sigK3\_matches\_hodge} & {\footnotesize Signature (b, b) of a non-degenerate real quadratic form. -/ structure Signature where pos :  neg :  deriving DecidableEq, Repr namespace Signature in} \\
\quad\texttt{\footnotesize sigMukai\_eq} & {\footnotesize } \\
\multicolumn{2}{l}{\textsf{\small DualScaleStream2.Lattice.Mukai}} \\
\quad\texttt{\footnotesize hyperbolicUNeg\_mul\_self} & {\footnotesize } \\
\quad\texttt{\footnotesize hyperbolicUNeg\_unimodular} & {\footnotesize } \\
\quad\texttt{\footnotesize mukaiPair\_even} & {\footnotesize A Mukai vector (r, c, s)  H  H  H. -/ structure MukaiVec (n : ) where (r : ) (c : Fin n  ) (s : ) /-- Huybrechts Def. 1.4. -/ def mukaiPair (n : ) (L } \\
\quad\texttt{\footnotesize mukaiPair\_self} & {\footnotesize } \\
\quad\texttt{\footnotesize mukaiPair\_symm} & {\footnotesize } \\
\quad\texttt{\footnotesize structureSheaf\_mukai\_sq} & {\footnotesize A Mukai vector (r, c, s)  H  H  H. -/ structure MukaiVec (n : ) where (r : ) (c : Fin n  ) (s : ) /-- Huybrechts Def. 1.4. -/ def mukaiPair (n : ) (L } \\
\multicolumn{2}{l}{\textsf{\small DualScaleStream2.Lattice.Reflection}} \\
\quad\texttt{\footnotesize e8Neg\_simpleRoot\_norm} & {\footnotesize Reflection matrix s\_v = 1 + v v L (so s\_v x = x + x, v v with x, v = v L x). -/ def reflection (L : Gram n) (v : Fin n  ) : Gram n := 1 + vecMulVec v } \\
\quad\texttt{\footnotesize e8Neg\_weyl\_isometry} & {\footnotesize Reflection matrix s\_v = 1 + v v L (so s\_v x = x + x, v v with x, v = v L x). -/ def reflection (L : Gram n) (v : Fin n  ) : Gram n := 1 + vecMulVec v } \\
\quad\texttt{\footnotesize reflection\_involution} & {\footnotesize Reflection matrix s\_v = 1 + v v L (so s\_v x = x + x, v v with x, v = v L x). -/ def reflection (L : Gram n) (v : Fin n  ) : Gram n := 1 + vecMulVec v } \\
\quad\texttt{\footnotesize reflection\_isometry} & {\footnotesize Reflection matrix s\_v = 1 + v v L (so s\_v x = x + x, v v with x, v = v L x). -/ def reflection (L : Gram n) (v : Fin n  ) : Gram n := 1 + vecMulVec v } \\
\quad\texttt{\footnotesize vecMulVec\_mul\_self} & {\footnotesize Reflection matrix s\_v = 1 + v v L (so s\_v x = x + x, v v with x, v = v L x). -/ def reflection (L : Gram n) (v : Fin n  ) : Gram n := 1 + vecMulVec v } \\
...
\quad\texttt{\footnotesize chargeNorm\_even} & {\footnotesize e\_k: the matrix unit at (k,k). -/ def proj (k : Fin d) : Matrix (Fin d) (Fin d)  := single k k 1 /-- Factorized duality D\_k (GPR eq. (2.4.29)). -/ def} \\
\quad\texttt{\footnotesize chargeNorm\_invariant} & {\footnotesize e\_k: the matrix unit at (k,k). -/ def proj (k : Fin d) : Matrix (Fin d) (Fin d)  := single k k 1 /-- Factorized duality D\_k (GPR eq. (2.4.29)). -/ def} \\
\quad\texttt{\footnotesize chargeNorm\_sumElim} & {\footnotesize } \\
\quad\texttt{\footnotesize factorized\_comm} & {\footnotesize } \\
\quad\texttt{\footnotesize factorized\_isODD} & {\footnotesize } \\
\quad\texttt{\footnotesize factorized\_mul\_self} & {\footnotesize } \\
\quad\texttt{\footnotesize factorized\_two} & {\footnotesize e\_k: the matrix unit at (k,k). -/ def proj (k : Fin d) : Matrix (Fin d) (Fin d)  := single k k 1 /-- Factorized duality D\_k (GPR eq. (2.4.29)). -/ def} \\
\quad\texttt{\footnotesize proj\_comm} & {\footnotesize e\_k: the matrix unit at (k,k). -/ def proj (k : Fin d) : Matrix (Fin d) (Fin d)  := single k k 1 /-- Factorized duality D\_k (GPR eq. (2.4.29)). -/ def} \\
\quad\texttt{\footnotesize proj\_mul\_self} & {\footnotesize } \\
\quad\texttt{\footnotesize proj\_transpose} & {\footnotesize } \\
\multicolumn{2}{l}{\textsf{\small DualScaleStream2.TDuality.Mirror}} \\
\quad\texttt{\footnotesize mirrorTheta\_antisymm} & {\footnotesize } \\
\quad\texttt{\footnotesize mirror\_conjugates\_tauShift} & {\footnotesize T = [[1,1],[0,1]]. -/ def tauShift : Matrix (Fin 2) (Fin 2)  := !![1, 1; 0, 1] /-- (T) = [[1,0],[-1,1]]. -/ def tauShiftDual : Matrix (Fin 2) (Fin 2) } \\
\quad\texttt{\footnotesize tauShift\_dual\_spec} & {\footnotesize } \\
\quad\texttt{\footnotesize tauShift\_isODD} & {\footnotesize T = [[1,1],[0,1]]. -/ def tauShift : Matrix (Fin 2) (Fin 2)  := !![1, 1; 0, 1] /-- (T) = [[1,0],[-1,1]]. -/ def tauShiftDual : Matrix (Fin 2) (Fin 2) } \\
\multicolumn{2}{l}{\textsf{\small DualScaleStream2.TDuality.ODD}} \\
\quad\texttt{\footnotesize basisChange\_isODD} & {\footnotesize } \\
\quad\texttt{\footnotesize eta\_isODD} & {\footnotesize Charge-lattice index set: d momenta  d windings. -/ abbrev Charge (d : ) := Fin d  Fin d /-- The O(d,d)-invariant form  = [[0, I],[I, 0]]. -/ def eta } \\
\quad\texttt{\footnotesize eta\_mul\_self} & {\footnotesize Charge-lattice index set: d momenta  d windings. -/ abbrev Charge (d : ) := Fin d  Fin d /-- The O(d,d)-invariant form  = [[0, I],[I, 0]]. -/ def eta } \\
\quad\texttt{\footnotesize eta\_one\_reindex} & {\footnotesize Charge-lattice index set: d momenta  d windings. -/ abbrev Charge (d : ) := Fin d  Fin d /-- The O(d,d)-invariant form  = [[0, I],[I, 0]]. -/ def eta } \\
\quad\texttt{\footnotesize isODD\_mul} & {\footnotesize Charge-lattice index set: d momenta  d windings. -/ abbrev Charge (d : ) := Fin d  Fin d /-- The O(d,d)-invariant form  = [[0, I],[I, 0]]. -/ def eta } \\
\quad\texttt{\footnotesize thetaShift\_isODD} & {\footnotesize } \\
\multicolumn{2}{l}{\textsf{\small DualScaleStream2.TDuality.SL2Product}} \\
\quad\texttt{\footnotesize basisChange\_comm\_thetaShift} & {\footnotesize J = [[0,1],[-1,0]]. -/ def jMat : Matrix (Fin 2) (Fin 2)  := !![0, 1; -1, 0] theorem mul\_jMat\_mul\_transpose (A : Matrix (Fin 2) (Fin 2) ) : A jMat A =} \\
\quad\texttt{\footnotesize basisChange\_mul} & {\footnotesize } \\
\quad\texttt{\footnotesize mul\_jMat\_mul\_transpose} & {\footnotesize } \\
\quad\texttt{\footnotesize thetaShift\_mul} & {\footnotesize } \\
\multicolumn{2}{l}{\textsf{\small DualScaleStream2.TDuality.Spectrum}} \\
\quad\texttt{\footnotesize eta\_transpose} & {\footnotesize Helper:  is symmetric.} \\
\quad\texttt{\footnotesize isODD\_inv\_isODD} & {\footnotesize } \\
\quad\texttt{\footnotesize isODD\_left\_inv} & {\footnotesize } \\
\quad\texttt{\footnotesize isODD\_right\_inv} & {\footnotesize } \\
\quad\texttt{\footnotesize spectrum\_equivalence} & {\footnotesize Helper:  is symmetric. -/ theorem eta\_transpose : (eta d) = eta d := by unfold eta rw [fromBlocks\_transpose] simp theorem isODD\_inv\_isODD (g : Matrix } \\
\end{longtable}
\section*{\texttt{StringTheoryFormalization} (89 theorems)}
\begin{longtable}{p{0.40\textwidth}p{0.55\textwidth}}\toprule Theorem & First line of its docstring \\ \midrule\endhead\bottomrule\endfoot
...
\quad\texttt{\footnotesize chiral\_primary\_ring\_associativity} & {\footnotesize N=2 superconformal algebra charges for a state. -/ structure N2State where /-- Conformal weight h  0. -/ confWeight :  /-- U(1)\_R charge q   (after sp} \\
\quad\texttt{\footnotesize chiral\_primary\_saturates\_bps} & {\footnotesize N=2 superconformal algebra charges for a state. -/ structure N2State where /-- Conformal weight h  0. -/ confWeight :  /-- U(1)\_R charge q   (after sp} \\
\quad\texttt{\footnotesize k3\_chiral\_primary\_total} & {\footnotesize N=2 superconformal algebra charges for a state. -/ structure N2State where /-- Conformal weight h  0. -/ confWeight :  /-- U(1)\_R charge q   (after sp} \\
...
\quad\texttt{\footnotesize hodge11\_from\_kummer} & {\footnotesize The Hodge numbers of K3 as a function (p,q)  . -/ def k3HodgeNumber : Fin 3  Fin 3   | 0, \_, 0, \_ => 1 -- h\^{}(0,0) = 1 | 0, \_, 1, \_ => 0 -- h\^{}(0,1) = 0} \\
\quad\texttt{\footnotesize k3\_b2} & {\footnotesize The Hodge numbers of K3 as a function (p,q)  . -/ def k3HodgeNumber : Fin 3  Fin 3   | 0, \_, 0, \_ => 1 -- h\^{}(0,0) = 1 | 0, \_, 1, \_ => 0 -- h\^{}(0,1) = 0} \\
\quad\texttt{\footnotesize k3\_euler\_characteristic} & {\footnotesize The Hodge numbers of K3 as a function (p,q)  . -/ def k3HodgeNumber : Fin 3  Fin 3   | 0, \_, 0, \_ => 1 -- h\^{}(0,0) = 1 | 0, \_, 1, \_ => 0 -- h\^{}(0,1) = 0} \\
\quad\texttt{\footnotesize k3\_hodge\_symmetry} & {\footnotesize The Hodge numbers of K3 as a function (p,q)  . -/ def k3HodgeNumber : Fin 3  Fin 3   | 0, \_, 0, \_ => 1 -- h\^{}(0,0) = 1 | 0, \_, 1, \_ => 0 -- h\^{}(0,1) = 0} \\
\quad\texttt{\footnotesize k3\_serre\_duality} & {\footnotesize The Hodge numbers of K3 as a function (p,q)  . -/ def k3HodgeNumber : Fin 3  Fin 3   | 0, \_, 0, \_ => 1 -- h\^{}(0,0) = 1 | 0, \_, 1, \_ => 0 -- h\^{}(0,1) = 0} \\
\multicolumn{2}{l}{\textsf{\small StringTheoryFormalization.Frontier.ModuliGeodesics}} \\
\quad\texttt{\footnotesize geodesic\_equation\_kummer\_locus} & {\footnotesize A point in the K3 moduli space: a complex structure on K3 encoded by its period point in the Mukai lattice \^{}(4,20). -/ structure K3ModuliPoint where /} \\
\quad\texttt{\footnotesize poincare\_geodesic\_atlas\_curvature} & {\footnotesize A point in the K3 moduli space: a complex structure on K3 encoded by its period point in the Mukai lattice \^{}(4,20). -/ structure K3ModuliPoint where /} \\
\quad\texttt{\footnotesize poincare\_geodesic\_kinetic\_energy\_nonneg} & {\footnotesize A point in the K3 moduli space: a complex structure on K3 encoded by its period point in the Mukai lattice \^{}(4,20). -/ structure K3ModuliPoint where /} \\
\quad\texttt{\footnotesize wp\_geodesic\_completeness} & {\footnotesize A point in the K3 moduli space: a complex structure on K3 encoded by its period point in the Mukai lattice \^{}(4,20). -/ structure K3ModuliPoint where /} \\
\quad\texttt{\footnotesize wp\_metric\_positive\_diagonal} & {\footnotesize A point in the K3 moduli space: a complex structure on K3 encoded by its period point in the Mukai lattice \^{}(4,20). -/ structure K3ModuliPoint where /} \\
...
\quad\texttt{\footnotesize bps\_ratio\_pos} & {\footnotesize The BPS index ratio \_BPS = 77/60, arising from the ratio of the K3 Euler characteristic (K3) = 24 to the index density. -/ def bpsRatio :  := 77 / 60 } \\
\quad\texttt{\footnotesize bps\_ratio\_reduced} & {\footnotesize The BPS index ratio \_BPS = 77/60, arising from the ratio of the K3 Euler characteristic (K3) = 24 to the index density. -/ def bpsRatio :  := 77 / 60 } \\
\multicolumn{2}{l}{\textsf{\small StringTheoryFormalization.StringDynamics.FourierMukai}} \\
\quad\texttt{\footnotesize fm\_isEquivalence\_of\_mk} & {\footnotesize Placeholder type for a triangulated category (D\^{}b of coherent sheaves). -/ structure DerivedCategory (X : Type) where name : String /-- The Fourier-Mu} \\
\quad\texttt{\footnotesize fm\_squared\_is\_shift} & {\footnotesize Placeholder type for a triangulated category (D\^{}b of coherent sheaves). -/ structure DerivedCategory (X : Type) where name : String /-- The Fourier-Mu} \\
...
\quad\texttt{\footnotesize exceptional\_self\_intersection} & {\footnotesize The 16 exceptional divisors from the Kummer blowup of T/. -/ def kummerExceptionalDivisors : Fin 16  String := fun i => s!"E\_(i.val)" /-- Intersection} \\
\quad\texttt{\footnotesize kummer\_lattice\_contribution} & {\footnotesize The 16 exceptional divisors from the Kummer blowup of T/. -/ def kummerExceptionalDivisors : Fin 16  String := fun i => s!"E\_(i.val)" /-- Intersection} \\
...
\quad\texttt{\footnotesize kummer\_sublattice\_rank} & {\footnotesize Signature (4,20) lattice for K3 cohomology. Rank = 24, signature = (4,20), discriminant = 1 (unimodular). -/ structure MukaiLattice where /-- Basis ve} \\
\quad\texttt{\footnotesize mukai\_rank} & {\footnotesize Signature (4,20) lattice for K3 cohomology. Rank = 24, signature = (4,20), discriminant = 1 (unimodular). -/ structure MukaiLattice where /-- Basis ve} \\
\multicolumn{2}{l}{\textsf{\small StringTheoryFormalization.StringDynamics.MukhanovSasaki}} \\
\quad\texttt{\footnotesize ms\_superhorizon\_freezing} & {\footnotesize Mukhanov-Sasaki variable v\_k in Fourier space. Satisfies: v\_k'' + (k - z''/z) v\_k = 0 where z = a ' / H (slow-roll pump field). -/ structure MSSolutio} \\
\multicolumn{2}{l}{\textsf{\small StringTheoryFormalization.StringDynamics.ODDMetric}} \\
\quad\texttt{\footnotesize odd\_metric\_d1} & {\footnotesize The O(D,D) invariant metric \_(MN) = [[0, 1\_D],[1\_D, 0]]. This is the split-signature metric on \^{}(2D). -/ def oddMetric : Matrix (Fin (2 D)) (Fin (2 D)} \\
\quad\texttt{\footnotesize odd\_metric\_symm} & {\footnotesize The O(D,D) invariant metric \_(MN) = [[0, 1\_D],[1\_D, 0]]. This is the split-signature metric on \^{}(2D). -/ def oddMetric : Matrix (Fin (2 D)) (Fin (2 D)} \\
...
\quad\texttt{\footnotesize de\_sitter\_conjecture} & {\footnotesize The Swampland Distance Conjecture (SDC): Along any geodesic in moduli space of length   O(1) in Planck units, an infinite tower of states becomes ligh} \\
\quad\texttt{\footnotesize sdc\_tower\_mass\_pos} & {\footnotesize The Swampland Distance Conjecture (SDC): Along any geodesic in moduli space of length   O(1) in Planck units, an infinite tower of states becomes ligh} \\
\quad\texttt{\footnotesize sdc\_tower\_suppression} & {\footnotesize The Swampland Distance Conjecture (SDC): Along any geodesic in moduli space of length   O(1) in Planck units, an infinite tower of states becomes ligh} \\
...
\quad\texttt{\footnotesize tduality\_involution} & {\footnotesize T-duality radius inversion: R  '/R. -/ noncomputable def tDualityRadius (R ' : ) (hR : 0 < R) (h : 0 < ') :  := ' / R /-- T-duality swaps winding and } \\
\multicolumn{2}{l}{\textsf{\small StringTheoryFormalization.StringDynamics.TadpoleConstraint}} \\
\quad\texttt{\footnotesize tadpole\_cancellation} & {\footnotesize A D3-brane charge contribution at a stack location. -/ structure BraneStack where /-- Number of D3 branes (positive = brane, negative = anti-brane). -} \\
...
\quad\texttt{\footnotesize bMinus\_eq\_nineteen} & {\footnotesize } \\
\quad\texttt{\footnotesize bPlus\_eq\_three} & {\footnotesize } \\
...
\quad\texttt{\footnotesize betti\_sum\_eq\_b2} & {\footnotesize } \\
...
\quad\texttt{\footnotesize M21\_order\_factorization} & {\footnotesize Order of M (ATLAS). -/ def orderM23 :  := 10200960 /-- Order of M (ATLAS). -/ def orderM22 :  := 443520 /-- Order of M  PSL(3,4) (ATLAS). -/ def order} \\
\quad\texttt{\footnotesize M22\_stabilizer\_index} & {\footnotesize Order of M (ATLAS). -/ def orderM23 :  := 10200960 /-- Order of M (ATLAS). -/ def orderM22 :  := 443520 /-- Order of M  PSL(3,4) (ATLAS). -/ def order} \\
\quad\texttt{\footnotesize M23\_stabilizer\_index} & {\footnotesize Order of M (ATLAS). -/ def orderM23 :  := 10200960 /-- Order of M (ATLAS). -/ def orderM22 :  := 443520 /-- Order of M  PSL(3,4) (ATLAS). -/ def order} \\
\quad\texttt{\footnotesize M24\_stabilizer\_index} & {\footnotesize Order of M (ATLAS). -/ def orderM23 :  := 10200960 /-- Order of M (ATLAS). -/ def orderM22 :  := 443520 /-- Order of M  PSL(3,4) (ATLAS). -/ def order} \\
\quad\texttt{\footnotesize mathieu\_tower\_consistent} & {\footnotesize Order of M (ATLAS). -/ def orderM23 :  := 10200960 /-- Order of M (ATLAS). -/ def orderM22 :  := 443520 /-- Order of M  PSL(3,4) (ATLAS). -/ def order} \\
\quad\texttt{\footnotesize mathieu\_tower\_matches\_certified\_order} & {\footnotesize Order of M (ATLAS). -/ def orderM23 :  := 10200960 /-- Order of M (ATLAS). -/ def orderM22 :  := 443520 /-- Order of M  PSL(3,4) (ATLAS). -/ def order} \\
\multicolumn{2}{l}{\textsf{\small StringTheoryFormalization.UseCases.NarainLattice}} \\
\quad\texttt{\footnotesize B\_is\_polarization\_of\_Q} & {\footnotesize } \\
