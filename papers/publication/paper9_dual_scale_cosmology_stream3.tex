...
paper says. The kernel cannot catch a false Tier~L citation; only a human re-reading the source
...
\Cref{sec:towers} was closed by the human orchestrator directly. The error was found only when a
...
this repository: \textbf{456 theorems, 0 failing}.
