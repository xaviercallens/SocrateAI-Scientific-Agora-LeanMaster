...
every theorem and lemma (**600 audited theorems across the ten first-party libraries** depend on
...
| **Kernel Verification** | None (paper only) | 600/600 audited theorems across ten libraries: 0 sorry, standard axioms only | Tier A |
...
```
Last full run (2026-09-18), **600 theorems audited across all ten libraries, 0 failing**:
