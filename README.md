...
every theorem and lemma (**533 audited theorems across the nine first-party libraries** depend on
...
| **Kernel Verification** | None (paper only) | 533/533 audited theorems across nine libraries: 0 sorry, standard axioms only | Tier A |
...
```
Last full run (2026-09-18), **533 theorems audited across all nine libraries, 0 failing**:
...
| `DualScaleMoonshine` (Stream 4) | 76 | 0 |
| **Total** | **533** | **0** |
