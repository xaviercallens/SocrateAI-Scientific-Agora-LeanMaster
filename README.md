...
every theorem and lemma (**693 audited theorems across the ten first-party libraries** depend on
...
| **Kernel Verification** | None (paper only) | 693/693 audited theorems across ten libraries: 0 sorry, standard axioms only | Tier A |
...
```
Last full run (2026-09-19, all ten libraries re-audited after v3.22.0; `DualScaleDyons` and `DualScaleStream2` re-audited after v3.27.0 (the audit tool now also covers attribute-prefixed theorems), the other eight unchanged since), **693 theorems audited across all ten libraries, 0 failing**:

| Library | Theorems audited | Failing |
|---|:---:|:---:|
| `DualScaleStream2` | 102 | 0 |
...
| `DualScaleDyons` (Streams 5, 8) | 106 | 0 |
| **Total** | **693** | **0** |
