...
every theorem and lemma (**611 audited theorems across the ten first-party libraries** depend on
...
| **Kernel Verification** | None (paper only) | 611/611 audited theorems across ten libraries: 0 sorry, standard axioms only | Tier A |
...
```
Last full run (2026-09-18), **611 theorems audited across all ten libraries, 0 failing**:
...
| `DualScaleCosmology` (Stream 3, with Stream 6's verdict) | 40 | 0 |
