...
every theorem and lemma (**621 audited theorems across the ten first-party libraries** depend on
...
| **Kernel Verification** | None (paper only) | 621/621 audited theorems across ten libraries: 0 sorry, standard axioms only | Tier A |
...
```
Last full run (2026-09-18), **621 theorems audited across all ten libraries, 0 failing**:
