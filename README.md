...
every theorem and lemma (**523 audited theorems across the nine first-party libraries** depend on
...
| **Kernel Verification** | None (paper only) | 523/523 audited theorems across nine libraries: 0 sorry, standard axioms only | Tier A |
...
```
Last full run (2026-09-18), **523 theorems audited across all nine libraries, 0 failing**:
...
| `DualScaleMoonshine` (Stream 4) | 66 | 0 |
| **Total** | **523** | **0** |
