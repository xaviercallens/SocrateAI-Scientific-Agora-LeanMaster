...
every theorem and lemma (**711 audited theorems across the ten first-party libraries** depend on
...
| **Kernel Verification** | None (paper only) | 711/711 audited theorems across ten libraries: 0 sorry, standard axioms only | Tier A |
...
```
Last full run (2026-09-19, all ten libraries re-audited on Lean v4.34.0-rc2 during the toolchain migration (§0b of `docs/VERIFIED_FOUNDATION.md`); `DualScaleDyons` and `DualScaleCosmology` re-audited after v3.30.0), **711 theorems audited across all ten libraries, 0 failing**:
