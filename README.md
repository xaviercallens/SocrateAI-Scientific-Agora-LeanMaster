...
every theorem and lemma (**555 audited theorems across the nine first-party libraries** depend on
...
| **Kernel Verification** | None (paper only) | 555/555 audited theorems across nine libraries: 0 sorry, standard axioms only | Tier A |
...
```
Last full run (2026-09-18), **555 theorems audited across all nine libraries, 0 failing**:
