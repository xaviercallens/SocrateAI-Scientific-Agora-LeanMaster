...
every theorem and lemma (**525 audited theorems across the nine first-party libraries** depend on
...
| **Kernel Verification** | None (paper only) | 525/525 audited theorems across nine libraries: 0 sorry, standard axioms only | Tier A |
...
```
Last full run (2026-09-18), **525 theorems audited across all nine libraries, 0 failing**:
...
| `DualScaleMoonshine` (Stream 4) | 68 | 0 |
| **Total** | **525** | **0** |
