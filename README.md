...
every theorem and lemma (**616 audited theorems across the ten first-party libraries** depend on
...
| **Kernel Verification** | None (paper only) | 616/616 audited theorems across ten libraries: 0 sorry, standard axioms only | Tier A |
...
```
Last full run (2026-09-18), **616 theorems audited across all ten libraries, 0 failing**:
...
| `DualScaleCosmology` (Stream 3, with the verdicts of Streams 6–7) | 45 | 0 |
| `DualScaleMoonshine` (Stream 4) | 101 | 0 |
| `DualScaleDyons` (Stream 5) | 44 | 0 |
| **Total** | **616** | **0** |
