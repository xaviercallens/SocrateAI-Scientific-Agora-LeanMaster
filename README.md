...
every theorem and lemma (**602 audited theorems across the ten first-party libraries** depend on
...
| **Kernel Verification** | None (paper only) | 602/602 audited theorems across ten libraries: 0 sorry, standard axioms only | Tier A |
...
```
Last full run (2026-09-18), **602 theorems audited across all ten libraries, 0 failing**:
