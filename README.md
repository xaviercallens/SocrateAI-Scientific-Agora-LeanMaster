...
every theorem and lemma (**626 audited theorems across the ten first-party libraries** depend on
...
| **Kernel Verification** | None (paper only) | 626/626 audited theorems across ten libraries: 0 sorry, standard axioms only | Tier A |
...
```
Last full run (2026-09-18), **626 theorems audited across all ten libraries, 0 failing**:
...
| `DualScaleDyons` (Streams 5, 8) | 49 | 0 |
| **Total** | **626** | **0** |
