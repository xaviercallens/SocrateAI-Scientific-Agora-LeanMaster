...
every theorem and lemma (**653 audited theorems across the ten first-party libraries** depend on
...
| **Kernel Verification** | None (paper only) | 653/653 audited theorems across ten libraries: 0 sorry, standard axioms only | Tier A |
...
```
Last full run (2026-09-19), **653 theorems audited across all ten libraries, 0 failing**:
...
| `DualScaleDyons` (Streams 5, 8) | 68 | 0 |
| **Total** | **653** | **0** |
